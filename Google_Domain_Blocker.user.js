...
//		GM_deleteValue('blDisplay');
	...
	addBlackListLinks: function() {
		...
		$('li.g').each(function() {
			...
			$(this).find('cite').parent().after('<div><span class="gl"><span class="blLink">Blacklist Domain</span><span class="blConfirm">Confirm: <span class="blyes">Yes</span> / <span class="blno">No</span></span></span><div>');
		});
	},
